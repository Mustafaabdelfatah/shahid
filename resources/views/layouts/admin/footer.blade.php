    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 text-center">
                <script>document.write(new Date().getFullYear())</script> © Iss-tech.com <b></b>
            </div>
        </div>
    </div>
</footer>
                            ...
                            <div class="col-4">
                                <div class="form-check form-switch card-switch mb-1">
                                    ...
                                    <label class="form-check-label" for="layout-color-light">
                                        ...
                                        <img src="{{ asset('assets/admin/images/default/layouts/light.png') }}" alt="" class="img-fluid">
                            ...
                            <div class="col-4">
                                <div class="form-check form-switch card-switch mb-1">
                                    ...
                                    <label class="form-check-label" for="layout-color-dark">
                                        <img src="{{ asset('assets/admin/images/default/layouts/dark.png') }}" alt="" class="img-fluid">
                                    </label>
                                </div>
                                    ...
                                    <div id="layout-boxed">
                                        <div class="form-check form-switch card-switch mb-1">
                                            ...
                                            <label class="form-check-label" for="layout-mode-boxed">
                                                <img src="{{ asset('assets/admin/images/default/layouts/boxed.png') }}" alt="" class="img-fluid">
                                            </label>
                                        </div>
                            ...
                            <div class="col-4">
                                <div class="form-check form-switch card-switch mb-1">
                                    ...
                                    <label class="form-check-label" for="topbar-color-dark">
                                        <img src="{{ asset('assets/admin/images/default/layouts/topbar-dark.png') }}" alt="" class="img-fluid">
                                    </label>
                                </div>
                                <h5 class="font-14 text-center text-muted mt-2">{{ __('Dark') }}</h5>
                            </div>
                                ...
                                <div class="col-4">
                                    <div class="form-check form-switch card-switch mb-1">
                                        ...
                                        <label class="form-check-label" for="leftbar-color-light">
                                            <img src="{{ asset('assets/admin/images/default/layouts/sidebar-light.png') }}" alt="" class="img-fluid">
                                        </label>
                                    </div>
                                    <h5 class="font-14 text-center text-muted mt-2">{{ __('Light') }}</h5>
                                </div>
                                ...
                                <div class="col-4">
                                    <div class="form-check form-switch card-switch mb-1">
                                        ...
                                        <label class="form-check-label" for="leftbar-size-compact">
                                            <img src="{{ asset('assets/admin/images/default/layouts/compact.png') }}" alt="" class="img-fluid">
                                        </label>
                                    </div>
                                ...
                                <div class="col-4">
                                    <div class="form-check form-switch card-switch mb-1">
                                        ...
                                        <label class="form-check-label" for="leftbar-size-small">
                                            <img src="{{ asset('assets/admin/images/default/layouts/sm.png') }}" alt="" class="img-fluid">
                                        </label>
                                    </div>
                                ...
                                <div class="col-4">
                                    <div class="form-check form-switch card-switch mb-1">
                                        ...
                                        <label class="form-check-label" for="leftbar-size-full">
                                            <img src="{{ asset('assets/admin/images/default/layouts/full.png') }}" alt="" class="img-fluid">
                                        </label>
                                    </div>
