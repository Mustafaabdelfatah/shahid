        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active text-info">{{ __('All Offers') }}</li>
                </ol>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.offers.create') }}"
                    class="btn btn-primary float-end">{{ __('Create Offers') }}</a>
            </div>

            <div class="card-body">
                <form id="update-pages" action="{{ route('admin.offers.actions') }}" method="post">
                    @csrf
                </form>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($item->status == 1)
                                                <li>
                                                    <a href="{{ route('admin.offers.update-status', $item->id) }}"
                                            ...
                                            @endif
                                            <li>
                                                <a href="{{ route('admin.offers.edit', [$item->id, 'id' => $item->id, 'page' => request('page')]) }}"
                                        ...
                                        @include('admin.pages.offers._model_delete')
                                    </div>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="7">{{ __('No offers available.') }}</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
