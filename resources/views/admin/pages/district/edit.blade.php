    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Create Districts') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" type="text"
                                                                name="{{ $locale }}[title]"
                                                                value="{{ old($locale . '.title', optional($district->trans()->where('locale', $locale)->first())->title) }}"
                                                                id="title{{ $index }}">
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input type="checkbox" class="form-check-input" id="customCheck3"
                                                        name="status" @checked($district->status == 1)>
