                    ...
                    <div class="row mt-3">
                        <div class="col-md-12 mt-1">
                            <input type="text"
                                ...
                                name="building_number" placeholder="ابحث برقم العمارة" class="form-control">
                        </div>
                        <div class="col-md-12 mt-1">
                        ...
                        <div class="modal-footer">
                            <a class="btn btn-purple btn-sm" href="{{ route('admin.units.prodcut_active') }}"><i
                                    class="ri-product-hunt-line"></i> {{ __('All Units Active') }}</a>
                            <a class="btn btn-danger btn-sm" href="{{ route('admin.units.prodcut_inactive') }}"><i
