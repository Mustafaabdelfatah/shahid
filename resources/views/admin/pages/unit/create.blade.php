                                        ...
                                        @endif
                                                    ...
                                                    <div class="mb-2 row">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea name="{{ $locale }}[description]" id="description{{ $index }}" class="form-control"
                                                                maxlength="5000" oninput="updateCharCount(this, {{ $index }})" cols="3" rows="10">{{ old($locale . '.description') }}</textarea>
                                                            <div class="d-flex justify-content-between">
                                                                <h4 class="text-muted">الحد الادني : 120 حرف</h4>
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label"
                                                                for="main_category">{{ __('Main Category') }}<span
                                                                    class="text-danger">*</span></label>
                                                            <select required class=" form-control" id="main_category"
                                                                name="main_category">
                                                                <option value="Administrative">{{ __('Select Category') }}
                                                                </option>
                                                                <option value="Administrative">{{ __('Administrative') }}
                                                                </option>
                                                                <option value="Residential">{{ __('Residential') }}
                                                                </option>
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label"
                                                                for="paying">{{ __('Unit Payment Method') }}<span
                                                                    class="text-danger">*</span></label>
                                                            <select required class=" form-control" id="paying"
                                                                name="paying">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label"
                                                                for="Furnished">{{ __('Furnished') }}<span
                                                                    class="text-danger">*</span></label>
                                                            <select required class=" form-control" id="Furnished"
                                                                name="Furnished">
                                                                <option>{{ __('Select Method') }}</option>
                                                                <option value="Furnished">{{ __('Furnished') }}
                                                                </option>
                                                                <option value="Unfurnished">{{ __('Unfurnished') }}
                                                                </option>
                                                            </select>
                                                            @error('Furnished')
                                                                <span class="text-danger">{{ $message }}</span>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select required class=" form-control" id="Finishing_type"
                                                                ...
                                                                <option value="finishing_text">{{ __('Finishing text') }}
                                                                </option>
                                                                <option value="super_deluxe">{{ __('Super deluxe') }}
                                                                </option>
                                                                <option value="lux">{{ __('Personal finishing') }}
                                                                </option>
                                                            </select>
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="form-label"
                                                                    for="building_number">{{ __('Building Number') }}<span
                                                                        class="text-danger">*</span></label>
                                                                <input required  type="text" class="form-control" id="building_number"
                                                                    name="building_number" placeholder="ادخل رقم العمارة" value="{{ old('building_number') }}">
