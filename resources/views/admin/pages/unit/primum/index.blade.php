        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.units.index') }}" class="btn btn-primary btn-sm"><i
                        class="ri-restart-line"> Restart</i></a>
                ...
                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>{{ optional($item->category->trans->where('locale', $current_lang)->first())->title }}
                            </td>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <li>
                                                    <a href="{{ route('admin.units.show', $item->id) }}"
                                                        class="btn text-pink dropdown-item text-center fa-bold" title="{{ __('Show') }}">
                                                        {{ __('Show') }}
                                                    </a>
                                                </li>
                                                <li>
