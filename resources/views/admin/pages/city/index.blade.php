    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">{{ __('All Cities') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.cities.create') }}" class="btn btn-primary float-end">{{ __('Create City') }}</a>
                </div>
                <div class="card-body">
                    <form id="update-pages" action="{{ route('admin.cities.actions') }}" method="post">
                        @csrf
                    </form>
                            ...
                            @forelse ($cities as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @include('admin.pages.city._model_delete')
                                    </td>
                                </tr>
                            @empty
                            @endforelse
