    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Create cities') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" type="text"
                                                                name="{{ $locale }}[title]"
                                                                value="{{ old($locale . '.title', optional($cities->trans()->where('locale', $locale)->first())->title) }}"
                                                                id="title{{ $index }}">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="panelsStayOpen-collapse" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                @if ($cities->image)
                                                <div class="mb-3">
                                                    <img src="{{ asset($cities->image) }}" width="250" alt="">
                                                </div>
                                                @endif

                                                @livewire('update-select-state-city-view', ['cities' => $cities])
                                                <div class="mb-3">
                                                    <label class="form-label" for="sort">{{ __('Sort') }}</label>
                                                    <input type="number" class="form-control" id="sort" name="sort"
                                                        value="{{ old('sort', $cities->sort) }}">
                                                    @error('sort')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input type="checkbox" class="form-check-input" id="customCheck3"
                                                        name="status" @checked($cities->status == 1)>
