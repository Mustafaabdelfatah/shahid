        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active text-info">{{ __('Edit Lands') }}</li>
                </ol>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form action="{{ route('admin.lands.update', $land->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="card-body">
                    <div class="row">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" name="{{ $locale }}[title]"
                                                            value="{{ old($locale . '.title', optional($land->trans()->where('locale', $locale)->first())->title) }}"
                                                            id="title{{ $index }}">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-12 mb-2">
                                                        ...
                                                        <textarea id="description{{ $index }}"
                                                            name="{{ $locale }}[description]"> {{ old($locale . '.description', optional($land->trans()->where('locale', $locale)->first())->description) }} </textarea>
                                    ...
                                    <div id="panelsStayOpen-collapse" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <div class="col-sm-12">
                                                ...
                                                @if($land->image)
                                                    <img src="{{ asset($land->image) }}" width="200"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="address" name="address"
                                                    value="{{ old('address', $land->address) }}">
                                                @error('address')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" class="form-check-input" id="customCheck3"
                                                    name="status" @checked($land->status == 1)>
