...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">{{__('Edit Featured')}}</h4>
        </div>
    </div>
</div>
<div class="row">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="{{ route('admin.features.index') }}" class="btn btn-primary float-end">{{ __('Back')
                            }}</a>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" name="{{ $locale }}[title]"
                                                        value="{{ old($locale . '.title', optional($feature->trans()->where('locale', $locale)->first())->title) }}"
                                                        id="title{{ $index }}">
