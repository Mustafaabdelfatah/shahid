    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">{{ __('All Countries') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.countries.create') }}"
                        class="btn btn-primary float-end">{{ __('Create Country') }}</a>

                </div>
                <div class="card-body">
                    <form id="update-pages" action="{{ route('admin.countries.actions') }}" method="post">
                        @csrf
                    </form>
                            ...
                            @forelse ($countries as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @include('admin.pages.country._model_delete')
                                    </td>
                                </tr>
                            @empty
                            @endforelse
