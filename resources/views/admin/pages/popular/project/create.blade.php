    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Create Popular Project And Units') }}</h4>
            </div>
        </div>
        <div class="col-12 d-flex justify-content-center">
            <div class="card w-100">
                ...
                <form action="{{ route('admin.popular-project.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            @livewire('popular-project')
                            <div class="col-md-12">
