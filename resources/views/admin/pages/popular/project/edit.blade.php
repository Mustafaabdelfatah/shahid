    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Edit Popular Project And Units') }}</h4>
            </div>
        </div>
            ...
            <div class="card w-100">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a href="{{ route('admin.popular-project.index') }}"
                                class="btn btn-primary float-end">{{ __('Back') }}</a>
                        </div>
                    </div>
                </div>
                <form action="{{ route('admin.popular-project.update', $popularCity->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            @livewire('update-popular-project', ['popularCity' => $popularCity])
                            <div class="col-md-12">
