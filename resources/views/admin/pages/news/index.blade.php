...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">{{__('All News')}}</h4>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.news.create') }}" class="btn btn-primary float-end">{{ __('Create News') }}</a>
                        ...
                        @forelse ($news as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @include('admin.pages.news._model_delete')
                                </td>
                            </tr>
                        @empty
                        @endforelse
