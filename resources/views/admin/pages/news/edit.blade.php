...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">{{ __('Edit News') }}</h4>
        </div>
    </div>
</div>
        ...
        <div class="card">
            ...
            <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-7">
                            <!-- Title and Description Accordion -->
                                            ...
                                            @foreach ($languages as $index => $locale)
                                                <div class="row mb-3">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="title{{ $index }}">
                                                            {{ __('Title in ') . Lang::get($locale) }}<span
                                                                class="text-danger">*</span>
                                                        </label>
                                                        <input class="form-control" type="text" name="{{ $locale }}[title]"
                                                            value="{{ old($locale . '.title', optional($news->trans()->where('locale', $locale)->first())->title) }}"
                                                            id="title{{ $index }}">
                                                        @error($locale . '.title')
                                                ...
                                                <div class="row mb-3">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="sub_title{{ $index }}">
                                                            {{ __('Sub Title') . Lang::get($locale) }}<span
                                                                class="text-danger">*</span>
                                                        </label>
                                                        <input class="form-control" type="text" name="{{ $locale }}[sub_title]"
                                                            value="{{ old($locale . '.sub_title', optional($news->trans()->where('locale', $locale)->first())->sub_title) }}"
                                                            id="sub_title{{ $index }}">
                                                ...
                                                <div class="row mb-3">
                                                    <label class="form-label" for="description{{ $index }}">
                                                        {{ __('Description in ') . Lang::get($locale) }}<span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-sm-12 mb-2">
                                                        <textarea id="description{{ $index }}"
                                                            name="{{ $locale }}[description]">{{ old($locale . '.description', optional($news->trans()->where('locale', $locale)->first())->description) }}</textarea>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="meta_title{{ $index }}">
                                                            {{ __('Meta Title ') . Lang::get($locale) }}
                                                        </label>
                                                        <input class="form-control" type="text"
                                                            name="{{ $locale }}[meta_title]"
                                                            value="{{ old($locale . '.meta_title', optional($news->trans()->where('locale', $locale)->first())->meta_title) }}"
                                                            id="meta_title{{ $index }}">
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label" for="meta_description{{ $index }}">
                                                            {{ __('Meta Description ') . Lang::get($locale) }}
                                                        </label>
                                                        <textarea name="{{ $locale }}[meta_description]"
                                                            class="form-control"
                                                            id="meta_description{{ $index }}">{{ old($locale . '.meta_description', optional($news->trans()->where('locale', $locale)->first())->meta_description) }}</textarea>
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label" for="meta_key{{ $index }}">
                                                            {{ __('Meta Keywords ') . Lang::get($locale) }}
                                                        </label>
                                                        <textarea name="{{ $locale }}[meta_key]" class="form-control"
                                                            id="meta_key{{ $index }}">{{ old($locale . '.meta_key', optional($news->trans()->where('locale', $locale)->first())->meta_key) }}</textarea>
                                                        @error($locale . '.meta_key')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <select class="select2 form-control select2-multiple_catgeory"
                                                    ...
                                                    @foreach ($categories as $item)
                                                        <option value="{{ $item->id }}" {{ $news->categories->contains('id', $item->id) ? 'selected' : '' }}>
