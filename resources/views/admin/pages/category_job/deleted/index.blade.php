...
@section('title', __('All Deleted Category Job'))
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active text-info">{{ __('All deleted Category Job') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('All deleted Category Job') }}</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ route('admin.category_job.index') }}" class="btn btn-primary float-end btn-sm">{{__('Back')}}</a>
                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            @forelse ($category_job as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @include('admin.pages.category_job.deleted._model_recovery', [
                                            'id' => $item->id,
                                        ])
                                        @include('admin.pages.category_job.deleted._model_delete', [
                                            'id' => $item->id,
                                        ])
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="12" class="text-center">{{ __('No category_job found') }}</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
