...
@section('title',__('Tag News'))
@section('content')
<div class="row">
    <div class="col-12">
        <div class="page-title-box">

            <h4 class="page-title">{{__('All Tags')}}</h4>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.tegs_news.create') }}" class="btn btn-primary float-end">{{ __('Create Tag') }}</a>

            </div>
            <div class="card-body">
                <form id="update-pages" action="{{ route('admin.tegs_news.actions') }}" method="post">
                    @csrf
                </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class=" d-flex  justify-content-around">
                                        ...
                                        <a href="{{ route('admin.tegs_news.edit', $item->id) }}"
                                    ...
                                    @include('admin.pages.TagNews._model_delete')
                                </td>
                            </tr>
                        @empty
                        @endforelse
            ...
            <div class="col-md-12 d-flex flex justify-content-center align-items-center">
                {{ $tegs_news->links('layouts.admin.pagination') }}
            </div>
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
