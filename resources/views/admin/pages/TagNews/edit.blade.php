    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Create Tag News') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a href="{{ route('admin.tegs_news.index') }}"
                                class="btn btn-primary float-end">{{ __('Back') }}</a>
                        </div>
                    </div>
                </div>
                <form action="{{ route('admin.tegs_news.update', $tegs_news->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" type="text"
                                                                name="{{ $locale }}[title]"
                                                                value="{{ old($locale . '.title', optional($tegs_news->trans()->where('locale', $locale)->first())->title) }}"
                                                                id="title{{ $index }}">
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input type="checkbox" class="form-check-input" id="customCheck3"
                                                        name="status" @checked($tegs_news->status == 1)>
