                    ...
                    <tbody>
                        @forelse ($products as $item)
                            <tr class="text-center">
                                ...
                                <td><img src="{{ asset($item->plan) }}" class="rounded" width="70" alt=""></td>
...
<script src="{{ asset('assets/admin/vendor/datatables.net-responsive-bs5/js/responsive.bootstrap5.min.js') }}">
</script>
