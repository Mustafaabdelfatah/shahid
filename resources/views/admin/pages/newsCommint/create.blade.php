            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a href="{{ route('admin.news-commint.index') }}"
                                class="btn btn-primary float-end">{{ __('Back') }}</a>
                        </div>
                    </div>
                </div>
                <form action="{{ route('admin.news-commint.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            <label for="Product" class="form-label">{{ __('New') }}</label>
                            <select class="form-control" id="Product" name="news_id">
