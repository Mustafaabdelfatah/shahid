    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Edit Facilities') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('admin.properties.update', $properties->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" type="text"
                                                                name="{{ $locale }}[title]"
                                                                value="{{ old($locale . '.title', optional($properties->trans()->where('locale', $locale)->first())->title) }}"
                                                                id="title{{ $index }}">
                                            ...
                                            <div class="accordion-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="sort" name="sort"
                                                        value="{{ old('sort', $properties->sort) }}">
                                                    @error('sort')
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input type="checkbox" class="form-check-input" id="customCheck3"
                                                        name="status" @checked($properties->status == 1)>
