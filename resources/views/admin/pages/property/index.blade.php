...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">{{ __('All Facilities') }}</h4>
        </div>
    </div>
</div>
<div class="row">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.properties.create') }}"
                    class="btn btn-primary float-end">{{ __('Create Facilities') }}</a>

            </div>
            <div class="card-body">

                <form id="update-pages" action="{{ route('admin.properties.actions') }}" method="post">
                    @csrf
                </form>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($item->status == 1)
                                                <li>
                                                    <a href="{{ route('admin.properties.update-status', $item->id) }}"
                                        ...
                                        @include('admin.pages.property._model_delete')
                                    </div>
                                </td>
                            </tr>
                        @empty
            ...
            <div class="col-md-12 d-flex flex justify-content-center align-items-center">
                {{ $properties->links('layouts.admin.pagination') }}
            </div>
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
