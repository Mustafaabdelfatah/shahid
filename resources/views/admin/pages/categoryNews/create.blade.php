...
@section('title',__('category News'))
@section('content')
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-4">
                    <a href="{{ route('admin.categories_news.index') }}" class="btn btn-primary float-end">{{ __('Back') }}</a>
                    </div>
                </div>
            </div>
            <form action="{{ route('admin.categories_news.store') }}" method="POST" >
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-7">
