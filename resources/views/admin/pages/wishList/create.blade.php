...
@section('title', __('Wish Lists'))
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Create Wish List') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a href="{{ route('admin.wish-list.index') }}"
                                class="btn btn-primary float-end">{{ __('Back') }}</a>
                        </div>
                    </div>
                </div>
                <form action="{{ route('admin.wish-list.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            {{-- <div class="col-lg-7">
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="select2 form-control select2-multiple"
                                                        ...
                                                        data-placeholder="{{ __('Choose users') }} ..." name="user_id">
