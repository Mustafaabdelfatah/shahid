    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Create gates') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('admin.gates.update', $gates->id) }}" method="POST"  enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="card-body">
                        <div class="row">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" type="text"
                                                                name="{{ $locale }}[title]"
                                                                value="{{ old($locale . '.title', optional($gates->trans()->where('locale', $locale)->first())->title) }}"
                                                                id="title{{ $index }}">
                                ...
                                <div class="accordion" id="accordionPanelsStayOpenExampleTag">
                                    <div class="accordion-item">
                                        ...
                                        <div id="panelsStayOpen-collapse" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                {{-- @livewire('update-select-gates-view', ['gates' => $gates]) --}}
                                                <div class="col-sm-12">
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                    ...
                                                    <div class="row g-0 align-items-center col-md-12">
                                                        <div class=" row align-items-center mb-2">
                                                            <div class="col-md-3 m-1" style="position: relative; width:400px">
                                                                <!-- Delete Icon -->
                                                                <!-- Image -->
                                                                <img src="{{ asset($gates->image) }}" width="400"  class="img-fluid rounded-start" alt="...">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input type="checkbox" class="form-check-input" id="customCheck3"
                                                        name="status" @checked($gates->status == 1)>
