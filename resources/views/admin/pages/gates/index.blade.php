...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">{{ __('All Gates') }}</h4>
        </div>
    </div>
</div>
<div class="row">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.gates.create') }}"
                    class="btn btn-primary float-end">{{ __('Create Gates') }}</a>

            </div>
            <div class="card-body">
                {{-- <form id="update-pages" action="{{ route('admin.gates.actions') }}" method="post">
                    @csrf
                </form> --}}
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($item->status == 1)
                                                <li>
                                                    <a href="{{ route('admin.gates.update-status', $item->id) }}"
                                            ...
                                            @endif
                                            <li>
                                                <a href="{{ route('admin.gates.edit', $item->id) }}"
                                        ...
                                        @include('admin.pages.gates._model_delete')
                                    </div>
                                </td>
                            </tr>
                        @empty
