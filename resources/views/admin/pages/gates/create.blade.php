    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('admin.gates.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-7">
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="mt-3 col-sm-12">
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <input type="checkbox" class="form-check-input" id="customCheck3" name="status" value="1">
