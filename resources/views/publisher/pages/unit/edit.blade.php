    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Edit Units') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('publisher.units.update', $unit->id) }}" method="POST"
                                                            ...
                                                            <div class="mb-3 row">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea name="{{ $locale }}[description]"
                                                                              ...
                                                                              cols="3"
                                                                              rows="10">{{  old($locale . '.description', optional($unit->trans()->where('locale', $locale)->first())->description) }}</textarea>
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label" for="plan">{{ __('Cover Photo')
                                                                        }}<span class="text-danger">*</span></label>
                                                                    <input type="file" class="form-control" id="plan"
                                                                        name="plan" value="{{ old('plan') }}">
                                                                    @error('plan')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                    @if ($unit->plan)
                                                                    <div class="m-2 row g-0 align-items-center col-md-12">
                                                                        <img src="{{ asset($unit->plan) }}" width="10%"
                                            ...
                                            <div class="accordion-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="mb-3">
                                                            <label class="form-label"
                                                                for="paying">{{ __('Unit sele Type') }}<span
                                                                    class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class=" form-control" id="Furnished" name="Furnished">
                                                                ...
                                                                <option value="Furnished" @selected($unit->Furnished == 'Furnished')>{{ __('Furnished') }}
                                                                </option>
                                                                <option value="Unfurnished" @selected($unit->Furnished == 'Unfurnished')>{{ __('Unfurnished') }}</option>
                                                            </select>
                                                            @error('Furnished')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class=" form-control" id="Finishing_type" name="Finishing_type">
                                                                <option>{{ __('Select Method') }}</option>
                                                                <option value="red_bricks" @selected($unit->Finishing_type == 'red_bricks')>{{ __('Red Bricks') }}</option>
                                                                <option value="finishing_text" @selected($unit->Finishing_type == 'finishing_text')>{{ __('Finishing text') }}</option>
                                                                <option value="super_deluxe" @selected($unit->Finishing_type == 'super_deluxe')>{{ __('Super deluxe') }}</option>
                                                                <option value="lux" @selected($unit->Finishing_type == 'lux')>{{ __('Lux') }}</option>
                                                            </select>
                                                    ...
                                                    {{-- <div class="col-sm-3 ">
                                                        <div class="mb-3">
                                                            <label class="form-label"
                                                                for="service_charges">{{ __('Service
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            Charges') }}</label>
                                                        ...
                                                        <div class="mt-2 accordion" id="accordionPanelsStayOpenExample">
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header" id="gates-accordion-header">
                                                                    <button class="accordion-button fw-medium collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#gates-accordion-content" aria-expanded="false" aria-controls="gates-accordion-content">
                                                                        {{ __('Gates') }}
                                                                    </button>
                                                                </h2>
                                                                <div id="gates-accordion-content" class="accordion-collapse collapse show">
                                                                    <div class="accordion-body">
                                                                        <div class="mb-3">
                                                                            <div>
                                                                                <div class="row">
                                                                                    @foreach ($gates as $gate)
                                                                                        <div class="col-md-6">
                                                                                            <div class="form-check">
                                                                                                <input class="form-check-input" type="checkbox" value="{{ $gate->id }}" id="gate-{{ $gate->id }}" name="gates[]" {{ $unit->gates->contains('id', $gate->id) ? 'checked' : '' }}>
                                                                                                <label class="form-check-label" for="gate-{{ $gate->id }}">
