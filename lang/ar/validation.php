...
return [
    ...
    | قواعد الحجم. لا تتردد في تعديل كل رسالة من هذه الرسائل هنا.
    |
    */
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute على أحرف أبجدية رقمية أحادية البايت فقط ورموز.',
    ...
    'decimal' => 'يجب أن يكون حقل :attribute عددًا بـ :decimal أماكن عشرية.',
    ...
    'password' => [
        ...
        'uncompromised' => 'القيمة :attribute المُعطاة قد ظهرت في تسريب بيانات. يرجى اختيار :attribute مختلفًا.',
    ],
    ...
    'unique' => 'قد تم اتخاذ :attribute بالفعل.',
    ...
    | الاتفاقية "attribute.rule" لتسمية السمة والقاعدة
    | على التوالي. هذا يتيح لك تخصيص النص الذي يتم استخدامه
    | من قبل المحقق للسمات محددة. انتقل إلى المورد الإنجليزي
    | ملف اللغة ونسخ أي رسائل التحقق التي ترغب في تخصيصها.
    |
    */
